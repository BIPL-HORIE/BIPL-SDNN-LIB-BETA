...
bipl::sdnn::base::sd::SDNN_SD_SINGLE::SDNN_SD_SINGLE():n_(0),n32_(0),adress_data_list_length_per2(0)
{
...
bipl::sdnn::base::sd::SDNN_SD_SINGLE::~SDNN_SD_SINGLE()
{
}

void bipl::sdnn::base::sd::SDNN_SD_SINGLE::InitSD(parameters::PARAMETERS &sdnn_parameter)
{
	...
	//パターンの初期化
	std::mt19937 mt;
	bipl::utility::InitMt(mt, sdnn_parameter, parameter_property::PARAM_SD_PC_RANDOM_SEED::property_.name_, parameter_property::PARAM_SD_PC_RANDOM_SEED::property_.default_);

	std::vector<std::string> init_type;
	auto judgement_buffer = std::make_unique<bipl::sdnn::parameter_property::PARAM_SD_PC_TYPE::JUDGEMENT_PC_TYPE_>(input_number_, n_);
	...
	for (unsigned int i = 0; i < input_number_; i++)
	{
		...
		bipl::lexial::Split(init_type_buffer, init_type[i], '(');
...
void bipl::sdnn::base::sd::SDNN_SD_SINGLE::MakePatternAndListWithMutual(void)
{
...
void bipl::sdnn::base::sd::SDNN_SD_SINGLE::MakePatternAndListWithFile(std::ifstream &sd_file)
{
...
void bipl::sdnn::base::sd::SDNN_SD_SINGLE::MakePatternAndListWithLine(std::vector<std::string> &line)
{
...
void bipl::sdnn::base::sd::SDNN_SD_SINGLE::SelectiveDesensitizationAstarisk(int* out_adress_data_list, const double* input)
{
	{
...
void bipl::sdnn::base::sd::SDNN_SD_SINGLE::SelectiveDesensitizationAstarisk_MultiThread(int* out_adress_data_list, const double* input)
{
	{
		const double *input_buffer = input;
		auto quantized_input_itr = quantized_input_.begin();
...
std::string bipl::sdnn::base::sd::SDNN_SD_SINGLE::GetDesensitizationList(void)
{
	std::string buffer = "[";
